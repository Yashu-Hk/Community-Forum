...
<a href="https://drive.google.com/file/d/1LPwnyR8kBhrFkP9cVWqf0VLt-_Gi6u-z/view?usp=drive_link" style="font-size: 25px;" target="_blank">About us</a>
</div>
<div class="col-md-3 box" style="padding-top: 30px">
...
<div class="modal fade title1" id="developers">
  <div class="modal-dialog">
    ...
    <div class="row">
    <div class="col-md-4">
     <img src="image.png" width=100 height=100 alt="Rajat Garg" class="img-rounded">
     </div>
     <div class="col-md-5">
    <a href="https://cdn-icons-png.freepik.com/256/15675/15675853.png?semt=ais_hybrid" style="color:#202020; font-family:'typo' ; font-size:18px" title="Find on Facebook">Dharanija</a>
    <h4 style="color:#202020; font-family:'typo' ;font-size:16px" class="title1">+91 7416227444</h4>
    <h4 style="font-family:'typo' ">dharanijanagarajan@gmail.com</h4>
